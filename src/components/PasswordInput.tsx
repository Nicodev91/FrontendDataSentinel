    ...
    <div className="w-full">
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-3 py-3 sm:py-4 pr-12 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-800 focus:border-transparent text-gray-900 text-sm sm:text-base placeholder-gray-500"
          placeholder="••••••••"
          required
        />
        <button
